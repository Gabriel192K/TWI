...
- Interrupt and machine state driven logic for both transmission and reception as `master` and `receiver`
- Callbacks for both transmission and reception as `slave`

## Tested on
- `ATmega328P` @16MHz using `Microchip Studio IDE` and `Arduino IDE` with a 400kHz TWI bus frequency
